...
//   - Processing a tape file (or live feed if no file given)
//   - Using a custom callback (OnNxCoreCallback)
...
int main(int argc, char *argv[])
{
    ...
    if (argc < 2)
    {
        std::cout << "NxCore Tape Reader (modernized C++17 version)\n\n";
